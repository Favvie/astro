...
import {
  ...
  Launchpad,
  Launchpad_CampaignCancelled,
  Launchpad_CampaignCreated,
  Launchpad_CampaignPromoted,
  Launchpad_FundingCompleted,
  Launchpad_LiquidityAdded,
  Launchpad_OgPointsAwarded,
  Launchpad_PlatformFeeUpdated,
  Launchpad_RefundClaimed,
  Launchpad_TokensPurchased,
  Launchpad_UserParticipatedInCampaign,
  LaunchpadV2,
  LaunchpadV2_CampaignCancelled,
  LaunchpadV2_LiquidityEvent,
  LaunchpadV2_RefundClaimed,
  LaunchpadV2_SwapEvent,
  Usdc,
  Usdc_Approval,
  Usdc_OwnershipTransferred,
  Usdc_Transfer,
} from "generated";
