...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface PowerLibInterface extends Interface {
  ...
  export interface PowerLib extends BaseContract {
    
    connect(runner?: ContractRunner | null): PowerLib;
    waitForDeployment(): Promise<this>;

    interface: PowerLibInterface;
